export default function InfoCard({ icon, label, total, bg }) {
  return (
    <div className="bg-white rounded-2xl p-4 sm:p-5 shadow-sm flex items-center gap-3 flex-1 min-w-50 max-w-xs transition-transform hover:-translate-y-0.5 hover:shadow-md">
      <div
