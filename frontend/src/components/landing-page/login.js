    ...
    >
          ...
          /* === SIGNUP VIEW === */
            <div className="animate-in fade-in zoom-in duration-300">
              <form onSubmit={handleRegisterSubmit} className="flex flex-col gap-4 text-left">
                <CustomInput label="Username" type="text" id="username" name="username" required={true} />
                <CustomInput label="Full name" type="text" id="fullname" name="fullname" required={true} />
                <CustomInput label="Password" type="password" id="password" name="password" required={true} />
                <CustomInput label="Confirm Password" type="password" id="confirmpassword" name="confirmpassword" required={true} />
      ...
      <div
        className={`fixed inset-0 z-[200] bg-black/50 backdrop-blur-sm flex items-center justify-center p-6 transition-opacity duration-200 ${
          showTerms ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
        }`}
      >
        <div
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto py-5 px-6 text-left [scrollbar-width:thin] [scrollbar-color:#ccc_transparent]">
            ...
            <p className={modalP}>
              All terms <strong className={modalStrong}>You, Your, and Yours</strong> refer to the Online PMS user — the individual who has registered or is attempting to register an account. <strong className={modalStrong}>We, Us, and Our</strong> refer to PENRO Pampanga. <strong className={modalStrong}>System</strong> refers to the Online PMS.
            </p>

            <h3 className={modalH3}>2. Account & Credentials</h3>
            <p className={modalP}>
              Your <strong className={modalStrong}>Username</strong> is the email address you provide during registration. <strong className={modalStrong}>Your access</strong> or <strong className={modalStrong}>system account</strong> refers to the combination of your email address and password registered in the system. The terms username and email address are used interchangeably. You are solely responsible for maintaining the confidentiality of your credentials.
            </p>

            <h3 className={modalH3}>3. Confidential Business Information (CBI)</h3>
            <p className={modalP}>
              The term <strong className={modalStrong}>Confidential Business Information (CBI)</strong> refers to information considered a trade secret — any formula, pattern, compilation, program, device, method, technique, or process whose economic value depends on remaining secret. You agree not to disclose CBI to any unauthorized third party.
            </p>

            <h3 className={modalH3}>4. User Conduct & Compliance</h3>
            <p className={modalP}>
              By registering, you agree to use the system responsibly and in full compliance with applicable <strong className={modalStrong}>Philippine laws, DENR regulations</strong>, and the policies set by PENRO Pampanga. Prohibited activities include submitting false information, unauthorized access, uploading harmful content, and impersonating others.
            </p>

            <h3 className={modalH3}>5. Consequences of Violation</h3>
            <p className={modalP}>
              Unauthorized access, misrepresentation, or misuse of the system may result in <strong className={modalStrong}>suspension of your account</strong> and appropriate legal action under applicable laws, including the Cybercrime Prevention Act of 2012 (RA 10175).
            </p>

            <h3 className={modalH3}>6. Amendments</h3>
            <p className={modalP}>
              PENRO Pampanga reserves the right to update these Terms and Conditions at any time. Continued use of the system after changes are posted constitutes your acceptance of the revised terms.
            </p>

            <h3 className={modalH3}>7. Governing Law</h3>
            <p className={modalP}>
              These Terms and Conditions shall be governed by and construed in accordance with the laws of the Republic of the Philippines. Disputes shall be subject to the jurisdiction of the appropriate Philippine courts.
            </p>
          </div>
