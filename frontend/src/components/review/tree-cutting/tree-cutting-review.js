    ...
    >
      <div className="max-w-6xl mx-auto w-full bg-white rounded-xl shadow-xl p-6 md:p-10 h-fit">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  type="text"
                  value={treeCutting?.treeCuttingAddress}
                  className={readOnlyInputClass}
                  readOnly
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  value={treeCutting?.noTreesToBeRemoved}
                  className={readOnlyInputClass}
                  readOnly
                />
              </div>
          ...
          {treeCutting?.application?.status === "APPROVED" ||
          treeCutting?.application?.status === "REJECTED" ? (
            <div>
