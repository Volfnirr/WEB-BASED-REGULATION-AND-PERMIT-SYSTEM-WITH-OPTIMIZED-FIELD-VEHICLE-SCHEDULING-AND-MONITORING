...
export default function ResidentialForm({ inspectors }) {
  ...
  return (
    <div
      className="flex flex-1 justify-center items-center w-full min-h-7/8  bg-[#4DAA74] overflow-y-auto p-4 mb-2 md:p-8 font-sans relative"
      // style={{ backgroundColor: "#4DAA74" }}
    >
      <div className="max-w-full mx-auto w-full bg-white rounded-xl shadow-xl p-6 md:p-10 h-fit">
